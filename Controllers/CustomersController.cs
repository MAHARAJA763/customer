...
using Task0605.Models;

namespace Task0605.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class CustomersController : ControllerBase
    {
        private readonly Assignment06052020Context _context;

        public CustomersController(Assignment06052020Context context)
        {
            _context = context;
        }
